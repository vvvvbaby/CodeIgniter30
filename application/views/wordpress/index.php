...
<![endif]-->
		...
		<!-- Fav and touch icons -->
		<link rel="shortcut icon"  href="<?php echo base_url() ?>assets/ico/favicon.ico" type="image/x-icon" />    
		...
		<link  href="<?php echo base_url() ?>assets/plugins/xcharts/css/xcharts.min.css" rel=" stylesheet">		
		<link  href="<?php echo base_url() ?>assets/plugins/fullcalendar/css/fullcalendar.css" rel="stylesheet">
		<link  href="<?php echo base_url() ?>assets/plugins/morris/css/morris.css" rel="stylesheet">
		<link  href="<?php echo base_url() ?>assets/plugins/jquery-ui/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
		<link  href="<?php echo base_url() ?>assets/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">	    
...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
	        ...
	        <ul class="nav navbar-nav navbar-right">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="<?php echo base_url() ?>assets/img/avatar1.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="<?php echo base_url() ?>assets/img/avatar2.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="<?php echo base_url() ?>assets/img/avatar3.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="<?php echo base_url() ?>assets/img/avatar4.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="<?php echo base_url() ?>assets/img/avatar5.jpg">
								<div>New message</div>
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="<?php echo base_url() ?>assets/img/avatar.jpg" alt="user-mail">jhonsmith@mail.com</a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header">
						...
						<li class="divider"></li>						
						<li><a href="mainform"><i class="fa fa-sign-out"></i> Logout</a></li>	
	        		</ul>
	      		</li>
				<li><a href="mainform"><i class="fa fa-power-off"></i></a></li>
			</ul>
			...
			<div class="sidebar ">
				...
				<div class="sidebar-collapse">
					<div class="sidebar-header t-center">
                        <span><img class="text-logo" src="<?php echo base_url() ?>assets/img/logo1.png"><i class="fa fa-space-shuttle fa-3x blue"></i></span>
                    </div>										
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="index"><i class="fa fa-laptop"></i><span class="text"> Dashboard</span></a></li>
							<li>
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> Pages</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="uploadfile"><i class="fa fa-car"></i><span class="text"> upload file</span></a></li>
									<li><a href="blog"><i class="fa fa-envelope"></i><span class="text"> Blog Entry</span></a></li>
									<li><a href="ajax"><i class="fa fa-credit-card"></i><span class="text"> Ajax test</span></a></li>						
									<li><a href="shop"><i class="fa fa-heart-o"></i><span class="text"> Shopping</span></a></li>
									...
									<li><a href="logout"><i class="fa fa-sign-in"></i><span class="text">logout</span></a></li>
								</ul>	
							</li>
							<li>
							...
							<li><a href="<?php echo site_url()?>/welcome/loadtablehtml"> <i class="fa fa-table"></i><span class="text"> Tables</span></a></li>
							<li>
							...
							<li <?php if(empty($widgets)) {echo 'style="display:none"';}?>><a href="widgets.html"><i class="fa fa-life-bouy"></i><span class="text"> Widgets</span></a></li>
							<li <?php if(empty($typography)) {echo 'style="display:none"';}?>><a href="typography"><i class="fa fa-font"></i><span class="text"> Typography</span></a></li>
							<li>
							...
							<li <?php if(empty($gallery)) {echo 'style="display:none"';}?>><a href="gallery.html"><i class="fa fa-picture-o"></i><span class="text"> Gallery</span></a></li>							
							<li <?php if(empty($calendar)) {echo 'style="display:none"';}?>><a href="calendar.html"><i class="fa fa-calendar"></i><span class="text"> Calendar</span></a></li>
						</ul>
					</div>					
				</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/Germany.png" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/India.png" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/Spain.png" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
									...
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/Russia.png" style="height:18px; margin-top:-2px;"></td>
										<td>Russia</td>
										<td>1258</td>
										<td>958</td>
										<td>
									...
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/usa.png" style="height:18px; margin-top:-2px;"></td>
										<td>USA</td>
										<td>4856</td>
										<td>3621</td>
										<td>
									...
									<tr>
										<td><img src="<?php echo base_url() ?>assets/ico/flags/brazil.png" style="height:18px; margin-top:-2px;"></td>
										<td>Brazil</td>
										<td>265</td>
										<td>102</td>
										<td>
	...
	<script src="<?php echo base_url() ?>assets/plugins/xcharts/js/xcharts.min.js"></script>
